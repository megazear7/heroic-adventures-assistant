...
description: Resolve rules questions with high-fidelity citations from workspace assets.
...
3. `assets/rules-index.md` for section lookup
4. `assets/rules-full.md` only when needed to fill gaps
